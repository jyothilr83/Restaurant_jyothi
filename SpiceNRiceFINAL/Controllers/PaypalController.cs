...
using SpiceNRice.Client.PaypalCheckoutExample.Client;
...
namespace SpiceNRice.Controllers
{
    public class PaypalController : Controller
    {
        ...
        public PaypalController(PaypalClient paypalClient,ICartRepository cartRepo,ShoppingCart shoppingCart)
        {
